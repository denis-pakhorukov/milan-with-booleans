...
void Scanner::nextToken() {
    ...
    if (isdigit(ch_)) {
        ...
        // Как только считали имя переменной, сравниваем ее со списком зарезервированных слов.
        // Если не совпадает ни с одним из них, считаем, что получили переменную, имя которой запоминаем,
        // а за текущую лексему считаем лексему идентификатора.
        ...
        switch (ch_) {
            ...
            case ';':
                ...
                nextChar();
                break;
                // Если встречаем ":", то дальше смотрим наличие символа "=".
                // Если находим, то считаем что нашли лексему присваивания
            ...
            case ':':
                ...
                break;
                // Если встретили символ "<", то либо следующий символ "=", тогда лексема нестрогого сравнения.
                // Иначе - строгого.
            case '<':
                token_ = T_CMP;
                nextChar();
